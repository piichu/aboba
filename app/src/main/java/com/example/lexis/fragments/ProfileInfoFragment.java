...
public class ProfileInfoFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.tvMemberSince.setText(String.format("С нами с %s", userJoined));
        binding.tvTargetLanguage.setText(String.format("%s %s", flag, targetLanguage));
        binding.tvVocabularyTarget.setText(String.format("%s слов изучено", targetLanguage));
    ...
    */
    private void fetchProfilePicture() {
        ...
        if (imageFile != null) {
            ...
            Drawable drawable = ContextCompat.getDrawable(getActivity(), R.drawable.profile_icon);
            Bitmap bitmap = null;
