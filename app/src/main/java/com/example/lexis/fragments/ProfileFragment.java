...
import static com.example.lexis.utilities.Utils.getProfilePictureUrl;
...
public class ProfileFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        try {
            ...
            Log.e("ProfileFragment", "Error inflating view", e);
            return null; // Или обработайте ошибку более корректно
        }
    }
        ...
        header = new AccountHeaderView(this.getActivity()) {{
            addProfiles(
                    ...
                    {{
                        ...
                        setName(new StringHolder(ParseUser.getCurrentUser().getUsername()));
                        setDescription(new StringHolder(ParseUser.getCurrentUser().getEmail()));
                        if(getProfilePictureUrl(ParseUser.getCurrentUser())!=null){
                            setIcon(new ImageHolder(getProfilePictureUrl(ParseUser.getCurrentUser())));
                        }
                        else{
                            setIcon(new ImageHolder(R.drawable.profile_icon));
                        }
