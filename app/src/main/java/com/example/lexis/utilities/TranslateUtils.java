...
public class TranslateUtils {
    ...
    */
    public static String translateSingleWord(String originalWord, String targetLanguage) throws TranslateException {
        ...
        translationAPI.setOnTranslationCompleteListener(new TranslationAPI.OnTranslationCompleteListener() {
            @Override
            ...
            @Override
            public String onCompleted(String text) {
                return text;
            }
        ...
        return translationAPI.doInBackground(originalWord, "ru", targetLanguage);
    }
